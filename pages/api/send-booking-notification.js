    ...
    const clientMailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
          ...
          <p style="margin-bottom: 20px; color: #555; line-height: 1.5;">Nuestro equipo revisará tu solicitud y te contactará en breve para confirmar la cita. Si necesitas cambiar la cita o tienes alguna pregunta, responde a este correo o llámanos al +34 644 544 899.</p>
