          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.instagram.com/elhueco.studio/?locale=es&hl=en" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
              ...
              <div className="mt-8">
                <a href="https://www.avisualpro.es/" target="_blank" rel="noopener noreferrer">
                  <Image
                    src="https://gplghsigeueslptewoji.supabase.co/storage/v1/object/public/servicios//partner.jpeg"
                    alt="AVisual Pro Logo"
                    width={150}
                    height={56}
                    className="w-auto h-12"
                    quality={100}
            ...
            <div>
              <div className="space-y-4">
                ...
                <div className="space-y-2 font-sans">
                  ...
                  <a href="tel:+34 644 54 48 99" className="block hover:text-accent-400">
                  +34 644 54 48 99 
                  </a>
                  <p>Av. de Daroca, 34</p>
                  <p>28017 Madrid</p>
