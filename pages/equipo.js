          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-16 md:gap-x-12">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="https://www.linkedin.com/in/irene-bona-b76470209/" target="_blank" rel="noopener noreferrer" className="text-sm text-black hover:text-gray-600">IN</a>
                <a href="https://www.instagram.com/ireenebona_/" target="_blank" rel="noopener noreferrer" className="text-sm text-black hover:text-gray-600">IG</a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="https://www.linkedin.com/in/paolo-zapico-marulli-aa8885233" target="_blank" rel="noopener noreferrer" className="text-sm text-black hover:text-gray-600">IN</a>
                <a href="https://www.instagram.com/paolozapico" target="_blank" rel="noopener noreferrer" className="text-sm text-black hover:text-gray-600">IG</a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="https://www.linkedin.com/in/rodrigotorrejonariza/" target="_blank" rel="noopener noreferrer" className="text-sm text-black hover:text-gray-600">IN</a>
                <a href="https://www.instagram.com/rodrilocuente/" target="_blank" rel="noopener noreferrer" className="text-sm text-black hover:text-gray-600">IG</a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="https://www.linkedin.com/in/eduardo-gutiérrez-tebar-5a3b91245" target="_blank" rel="noopener noreferrer" className="text-sm text-black hover:text-gray-600">IN</a>
                <a href="https://www.instagram.com/edu.guti" target="_blank" rel="noopener noreferrer" className="text-sm text-black hover:text-gray-600">IG</a>
              </div>
            </div>
          </div>
