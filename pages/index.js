            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="relative">
                <h2 className="text-2xl md:text-4xl lg:text-4xl font-helvetica tracking-tight leading-tight text-black text-justify relative z-10">
                  NO SE TRATA DE ENCONTRARLE UN HUECO A LAS IDEAS, SINO DE QUE LAS IDEAS ENCUENTREN SU <span className="relative z-10 font-orbitron font-semibold">HUECO</span>
                </h2>
                <div className="absolute right-[27%] top-[-32%] z-0 hidden">
                  <Image 
