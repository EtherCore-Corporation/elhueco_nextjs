      ...
      const clientEmailResponse = await fetch('/api/send-email', {
        ...
        body: JSON.stringify({
          ...
          text: `
            ...
            Nos pondremos en contacto contigo en la fecha y hora acordadas. Si necesitas cambiar la cita, por favor contáctanos en admin@el-hueco.es o llámanos al +34 644 544 899.
          ...
          html: `
            ...
            <p>Nos pondremos en contacto contigo en la fecha y hora acordadas. Si necesitas cambiar la cita, por favor contáctanos en <a href="mailto:admin@el-hueco.es" className="underline">admin@el-hueco.es</a> o llámanos al <a href="tel:+34644544899">+34 644 544 899</a>.</p>
