      ...
      <footer className="bg-black border-t border-gray-800">
        <div className="container mx-auto px-6 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://instagram.com/el_hueco" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
            ...
            <div>
              <h3 className="text-lg font-heading mb-4 tracking-wide">Navegación</h3>
            ...
            <div>
              <h3 className="text-lg font-heading mb-4 tracking-wide">Servicios</h3>
              <ul className="space-y-2 font-sans">
            ...
            <div>
              <div className="space-y-4">
                <h3 className="text-lg font-heading mb-4 tracking-wide">Contacto</h3>
                <div className="space-y-2 font-sans">
                  <a href="mailto:admin@el-hueco.es" className="block hover:text-accent-400">
                    admin@el-hueco.es
                  </a>
                  <a href="tel:+34644544899" className="block hover:text-accent-400">
                    +34 644 544 899
                  </a>
                  <p>Av. de Daroca, 34</p>
                  <p>28017 Madrid</p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <div className="mb-8">
              <h3 className="text-lg font-heading mb-4 tracking-wide text-center">Nuestros Partners</h3>
              <div className="flex justify-center items-center">
                <Image
                  src="https://gplghsigeueslptewoji.supabase.co/storage/v1/object/public/project-images//PARTNER.jpeg"
                  alt="Partner Logo"
                  width={150}
                  height={75}
            ...
            <p className="text-sm text-gray-500 font-sans">
              © {currentYear} El Hueco Studio. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
